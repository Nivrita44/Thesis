...
test('Boundary: p values all maximum except one minimum', () => {
  expect(solve(3, [1, 2, 4], [10000, 0, 10000])).toBe(0);
});
...
// √ Typical: Two different bits, 50-50 probability (3 ms)
//   √ All a[i] identical, different probabilities
//   √ Multiple elements, random a and p
//   √ Single element, p at maximum (1 ms)
//   √ Edge: All probabilities zero (1 ms)
//   √ Edge: All a[i] zero, all probability nonzero
//   √ Large n, identical a and p (59 ms)
//   √ Invalid: Zero items (1 ms)
//   × Boundary: p values all maximum except one minimum (5 ms)
//   √ Maximal input: n at MAX-1, a all ones, p all moderate (309 ms)