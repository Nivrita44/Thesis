...
test('example with [2, 2, 2, 2] should return YES', () => {
    expect(solve(4, [2, 2, 2, 2])).toBe('YES');
});
...
test('array with mixed valid pairs should return YES', () => {
    expect(solve(5, [2, 3, 3, 2, 2])).toBe('YES');
});