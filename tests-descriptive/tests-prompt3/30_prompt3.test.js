...
// × Sample 1: 2 spiders exchanging (5 ms)
//   × Sample 2: simple acyclic chain
//   × All spiders have a long cycle (1 ms)
//   × Single chain then cycle (1 ms)
//   × Tree-like structure ends in a 2-cycle (1 ms)
//   × Star shape into a cycle
//   × No entry nodes, direct cycle
//   × Edge: All spiders form a simple two cycle (1 ms)
//   × Edge: Disconnected chain to cycle (1 ms)
//   × Edge: Disconnected chains both into cycle
//   × Edge: n=2e5 maximal test, big cycle (146 ms)
