...
test('maximum size array with boundary selections', () => {
    expect(solve(100000, 50000, 3, [1, 50000, 100000])).toBe('1 3 5');
});

test('selections around current position', () => {
    expect(solve(10, 5, 5, [4, 5, 6, 7, 8])).toBe('2 3 4 5 6');
});
