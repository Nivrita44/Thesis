...
test('solve with single testcase', () => {
  expect(solve([[1, 0, 0]])).toEqual([0]);
  expect(solve([[1, 2, 3]])).toEqual([2]);
  expect(solve([[7, 4, 4]])).toEqual([4]);
});
...
test('solve n < b edge case', () => {
  expect(solve([[3, 5, 4]])).toEqual([2]);
  expect(solve([[100, 50, 20]])).toEqual([-50]);
});

test('solve large values', () => {
  expect(solve([[1000000, 0, 1000000000]])).toEqual([1000000000]);
  expect(solve([[1, 1000000000, 1000000000]])).toEqual([1000000000]);
});
