...
describe('solve function tests', () => {
    ...
    test('path with increasing weights', () => {
        const nodeCount = 5;
        const edgeCount = 4;
        const edges = [
            { u: 1, v: 2, w: 1 },
        ...
        const queries = [[1, 5, 4], [1, 3, 2], [2, 4, 3]];
        expect(solve(nodeCount, edgeCount, edges, queries)).toEqual([4, 2, 3]);
    });
    ...
    test('circular graph', () => {
        ...
        const queries = [[1, 3, 2], [2, 4, 2]];
        expect(solve(nodeCount, edgeCount, edges, queries)).toEqual([2, 2]);
    });
