...
// FAIL tests - descriptive / tests - prompt2 / 11 _prompt2.test.js× Basic test with 2 nodes and 1 edge(7 ms)× 3 nodes, 2 edges, reachable and unreachable cases(2 ms)√ No path exists(disconnected graph)(1 ms)√ Multiple queries, tie breaking on weight× All nodes self - queries(1 ms)√ Edge
// case :Empty graph(no queries returns empty)(1 ms)√ Edge
// case :One node loop(1 ms)√ Edge
// case :All nodes connected in a cycle

// ● Basic test with 2 nodes and 1 edge
...
// 11 | [1, 1, 0] // distance 0+0+1 = 1, answer 5
// 12 | ]; >
// 13 | expect(solve(nodeCount, edgeCount, edgeList, queryList)).toEqual([5, 5, -1, 5]); |
// ^
// 14 |
// });
// 15 |
// 16 | test('3 nodes, 2 edges, reachable and unreachable cases', () => {

//         at Object.toEqual(tests - descriptive / tests - prompt2 / 11 _prompt2.test.js: 13: 60)

//         ● 3 nodes, 2 edges, reachable and unreachable cases
...
//         27 | [3, 1, 3] // reverse direction, same as [1, 3, 3]
//         28 | ]; >
//     29 | expect(solve(nodeCount, edgeCount, edgeList, queryList)).toEqual([2, -1, 2, 2]); |
//     ^
//     30 |
// });
// 31 |
// 32 | test('No path exists (disconnected graph)', () => {

//         at Object.toEqual(tests - descriptive / tests - prompt2 / 11 _prompt2.test.js: 29: 60)

//         ● All nodes self - queries
...
//         74 | [3, 3, 2]
//         75 | ]; >
//     76 | expect(solve(nodeCount, edgeCount, edgeList, queryList)).toEqual([2, 2, 2]); |
//     ^
//     77 |
// });
// 78 |
// 79 | test('Edge case: Empty graph (no queries returns empty)', () => {

//         at Object.toEqual(tests - descriptive / tests - prompt2 / 11 _prompt2.test.js: 76: 60)