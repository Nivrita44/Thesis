...
// case 1(3 ms)√ example
// case 2√ input contains only 0(1 ms)√ single digit numbers below and above 9(1 ms)
// × number ending with 8(4 ms)√ number ending with 9(1 ms)√ number ending with 0(1 ms)√ large even and odd numbers(1 ms)√ input is an empty array
// × negative numbers(2 ms)
